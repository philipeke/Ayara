...
class AppLocalizationsMl extends AppLocalizations {
  ...
  @override
  String get dailyGraceSaintLabel => 'ആഴ്ചയിലെ പ്രതീകം';
  ...
  String get tasbihatDuaFarajNote =>
      'ഇമാം അൽ-മഹ്ദി (അഫ്) എന്ന പന്ത്രണ്ടാം ഇമാമിന്റെ വീണ്ടും പ്രത്യക്ഷപ്പെടലിന് വേണ്ടി ഒരു ദുആ, അദ്ദേഹത്തിന്റെ പിതാവിന്റെ ഉപദേശപ്രകാരം. ഇത് പല ഷിയ മുസ്ലിംമാർ പ്രാർത്ഥനയ്ക്ക് ശേഷം ജീവിച്ചിരിക്കുന്ന ഇമാമിന് സമർപ്പണമായി പലപ്പോഴും ഉച്ചരിക്കുന്നു.';
  ...
  @override
  String get imamsScreenTitle => 'നാല്പത് അശ്രഫന്മാർ';

  @override
  String get imamsScreenSubtitle =>
      'പ്രവാചകൻ, ലേഡി ഫാത്തിമ, പന്ത്രണ്ടു ഇമാമുകൾ - ത്വൽവറ ഷിയ ഇസ്ലാമിലെ ശുദ്ധമായ, തെറ്റില്ലാത്ത മാർഗദർശകർ';
  ...
  @override
  String get quickAction14Masumeen => 'നാല്പത് അശ്രഫന്മാർ';
  ...
  String get pilgrimageShiaNoteBody =>
      'പല ഷിയ തീർത്ഥാടകർ പ്രവാചകൻ മുഹമ്മദ് (സഅവ) യുടെ ziyarat നായി മദീനയിലേക്ക് യാത്ര ചെയ്യുന്നു, മസ്ജിദ് അൽ-നബവിയിലും ജന്നത് അൽ-ബാക്കി യിലെ കല്ലറകളിലും. ഈ സന്ദർശനങ്ങൾ ആഴത്തിലുള്ള ആത്മീയ പ്രാധാന്യം വഹിക്കുന്നു, എങ്കിലും അവ ഹജ്ജിന്റെ ചടങ്ങുകൾ അല്ല.';

  @override
  String get hajjIntro =>
      'ഹജ്ജ് ഇസ്ലാമിന്റെ അഞ്ചാം സ്തംഭമാണ്, ശാരീരികവും സാമ്പത്തികവും ആയ ശേഷമുള്ള ഓരോ മുസ്ലിംക്കും ജീവിതത്തിൽ ഒരിക്കൽ നിർബന്ധമായും ചെയ്യേണ്ടതാണ്. ഇന്ന് പല ത്വൽവറ ഷിയ തീർത്ഥാടകർക്ക്, ഇത് പ്രവാചകൻ ഇബ്രാഹിം (അസ്), അദ്ദേഹത്തിന്റെ മകൻ ഇസ്മായിൽ (അസ്), ലേഡി ഹാജർ എന്നിവരുടെ പാദങ്ങളിൽ ധുൽ ഹിജ്ജയുടെ മാസത്തിൽ നടത്തപ്പെടുന്ന ഹജ്ജ് അൽ-തമത്തുവാണ്. ഈ മാർഗ്ഗനിർദ്ദേശം ജാഫരി ചടങ്ങുകളുടെ രൂപരേഖ പിന്തുടരുന്നു, മദീനയിലെ ziyarat ഹജ്ജിന് മുമ്പോ ശേഷം ആഴത്തിൽ പ്രിയപ്പെട്ട ഒരു യാത്രയായി തുടരുന്നു.';
  ...
  @override
  String get voiceInputMicTitle => 'മൈക്രോഫോൺ';

  @override
  String get voiceInputMicSubtitle =>
      'തടവുകൾ ടൈപ്പ് ചെയ്യുന്നതിന് പകരം Ask Ayara-യിലേക്ക് നിങ്ങളുടെ ഇൻപുട്ട് സംസാരിക്കുക.';

  @override
  String get voiceInputMicDenied => 'മൈക്രോഫോൺ ആക്സസ് നിരസിച്ചു.';

  @override
  String get voiceInputSpeak => 'ബോധിപ്പിക്കുക';

  @override
  String get voiceInputListening => 'കേൾക്കുന്നു…';

  @override
  String get voiceInputPermissionDenied =>
      'ശബ്ദ ഇൻപുട്ടിന് മൈക്രോഫോൺ ആക്സസ് ആവശ്യമാണ്.';
}
