...
class AppLocalizationsMk extends AppLocalizations {
  ...
  @override
  String get dailyGraceSaintLabel => 'ЛИЧНОСТ НА НЕДЕЛАТА';
  ...
  String get tasbihatDuaFarajNote =>
      'Дуа за повторното појавување на Имам ал-Махди (аф), дванаесеттиот Имам, научена од неговиот татко. Често се чита од многу шиитски муслимани по молитва како акт на преданост кон живиот Имам.';
  ...
  @override
  String get imamsScreenTitle => 'Четиринаесетте Непогрешливи';

  @override
  String get imamsScreenSubtitle =>
      'Пророкот, госпоѓа Фатима и дванаесетте Имами — прочистените и непогрешливи водичи во дванаесеттиот шиитски ислам';
  ...
  @override
  String get quickAction14Masumeen => 'Четиринаесет Непогрешливи';
  ...
  String get pilgrimageShiaNoteBody =>
      'Многу шиитски поклоници исто така патуваат во Медина за зијарат на Пророкот Мухамед (САВ) во Масџид ал-Набави и гробовите во Џаннат ал-Баки. Овие посети носат длабоко духовно значење, иако самите не се обреди на Хаџ.';

  @override
  String get hajjIntro =>
      'Хаџ е петтиот столб на исламот, задолжителен еднаш во животот за секој муслиман кој е физички и финансиски способен. За повеќето дванаесетти шиитски поклоници денес, тоа значи Хаџ ал-Таматту\', извршен во месецот Дул Хиџа во стапките на Пророкот Ибрахим (АС), неговиот син Исмаил (АС) и госпоѓа Хаџар. Овој водич следи јафаријската структура на обредите, додека зијарат во Медина останува длабоко ценета патување пред или по Хаџ.';
  ...
  @override
  String get voiceInputTitle => 'Гласовен Внос';
  ...
  String get voiceInputMicSubtitle =>
      'Говорете го вашиот внос за да прашате Ayara наместо да пишувате.';

  @override
  String get voiceInputMicDenied => 'Пристапот до микрофонот беше одбиен.';

  @override
  String get voiceInputSpeak => 'Говори наместо';

  @override
  String get voiceInputListening => 'Слушање…';

  @override
  String get voiceInputPermissionDenied =>
      'Пристапот до микрофонот е потребен за гласовен внос.';
}
