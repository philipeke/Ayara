...
class AppLocalizationsSi extends AppLocalizations {
  ...
  @override
  String get dailyGraceSaintLabel => 'සතියේ උලමා';
  ...
  String get tasbihatDuaFarajNote =>
      'දොළොස්වන ඉමාම් වන ඉමාම් අල්-මහ්දි (af) නැවත පෙනී සිටීම සඳහා වූ dua එකකි. එය ඔහුගේ පියා විසින් ඉගැන්වීය. ජීවමාන ඉමාම්ට භක්තියක් වශයෙන් ශියා භක්තිකයින් විසින් සෑම සලාතයකටම පසු දෛනිකව කියවනු ලැබේ.';
  ...
  @override
  String get imamsScreenTitle => 'Masumeen 14 දෙනා';

  @override
  String get imamsScreenSubtitle =>
      'නබිතුමා, ලේඩි ෆාතිමා සහ දොළොස් ඉමාම්වරු — ඉස්ලාමයේ දෝෂ රහිත මගපෙන්වන්නෝ';
  ...
  String get pilgrimageShiaNoteBody =>
      'ශියා හජ්කරුවන් සාම්ප්‍රදායිකව මදීනා වෙතද ගොස් නබි මුහම්මද් ﷺ තුමාගේ Masjid al-Nabawi හි පිහිටි කබරිය සහ Jannat al-Baqi හි ඉමාම්වරුන්ගේ කබරිය යන්න. මෙම සංචාරයන් ගැඹුරු ආධ්‍යාත්මික වැදගත්කමක් දරන අතර, බොහෝ ශියා මුස්ලිම්වරුන්ට එය ගමනේ අභින්න කොටසක් ලෙස සැලකේ.';

  @override
  String get hajjIntro =>
      'හජ් යනු ඉස්ලාමයේ පස්වැනි කුළුණයි. ශාරීරික හා ආර්ථික හැකියාව ඇති සෑම මුස්ලිම්වරයෙකුටම ජීවිතයේ එක් වරක් එය අනිවාර්ය වේ. එය Dhul Hijjah මාසයේ සිදු කෙරෙන අතර, නබි ඉබ්‍රාහිම් (AS), ඔහුගේ පුත් ඉස්මාඉල් (AS), සහ ලේඩි හජර්ගේ පියවර අනුගමනය කරයි. ශියා මුස්ලිම්වරුන් සඳහා, හජ් යනු මදීනාහි නබිතුමා ﷺ සහ Ahlul Bayt විරාම ස්ථාන දර්ශනය කිරීමේ ගැඹුරු ආශීර්වාදයද ඇතුළත්ය.';
