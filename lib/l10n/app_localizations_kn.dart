...
class AppLocalizationsKn extends AppLocalizations {
  ...
  @override
  String get dailyGraceSaintLabel => 'ವಾರದ ವ್ಯಕ್ತಿ';
  ...
  String get tasbihatDuaFarajNote =>
      'ಇಮಾಮ್ ಅಲ್-ಮಹ್ದಿ (ಅಫ್) ಅವರ ಪುನಃಪ್ರಕಟಣೆಗೆ ಸಂಬಂಧಿಸಿದ ದುವಾ, ಅವರ ತಂದೆಯಿಂದ ಕಲಿತದ್ದು. ಇದು ಶಿಯಾ ಮುಸ್ಲಿಮರು ಪ್ರಾರ್ಥನೆಯ ನಂತರ ಜೀವಂತ ಇಮಾಮ್ ಗೆ ಭಕ್ತಿಯ ಕಾರ್ಯವಾಗಿ ಬಹಳಷ್ಟು ಓದುತ್ತಾರೆ.';
  ...
  @override
  String get imamsScreenTitle => 'ಹದಿನಾಲ್ಕು ನಿರ್ದೋಷರು';

  @override
  String get imamsScreenSubtitle =>
      'ನಬಿ, ಲೇಡಿ ಫಾತಿಮಾ ಮತ್ತು ಹದಿನಾಲ್ಕು ಇಮಾಮ್‌ಗಳು — ಹದಿನಾಲ್ಕು ಶಿಯಾ ಇಸ್ಲಾಮ್ನಲ್ಲಿ ಶುದ್ಧ ಮತ್ತು ನಿರ್ದೋಷ ಮಾರ್ಗದರ್ಶಕರು';
  ...
  @override
  String get quickAction14Masumeen => 'ಹದಿನಾಲ್ಕು ನಿರ್ದೋಷರು';
  ...
  String get pilgrimageShiaNoteBody =>
      'ಬಹಳಷ್ಟು ಶಿಯಾ ಯಾತ್ರಿಕರು ನಬಿ ಮುಹಮ್ಮದ್ (ಸಾ) ಅವರ ಜಿಯಾರತ್‌ಗಾಗಿ ಮದೀನಕ್ಕೆ ಪ್ರಯಾಣಿಸುತ್ತಾರೆ, ಮಸ್ಜಿದ್ ಅಲ್-ನಬಾವಿ ಮತ್ತು ಜನ್ನತ್ ಅಲ್-ಬಾಕಿ ಯಲ್ಲಿ ಸಮಾಧಿಗಳಲ್ಲಿ. ಈ ಭೇಟಿಗಳು ಆಳವಾದ ಆಧ್ಯಾತ್ಮಿಕ ಮಹತ್ವವನ್ನು ಹೊಂದಿವೆ, ಆದರೆ ಇವು ಹಜ್ಜ್‌ನ ವಿಧಿಗಳನ್ನು ಅಲ್ಲ.';

  @override
  String get hajjIntro =>
      'ಹಜ್ಜ್ ಇಸ್ಲಾಮ್ನ ಐದನೇ ಕೋಷ್ಟಕ, ಪ್ರತಿ ಮುಸ್ಲಿಮನಿಗೆ ಶಾರೀರಿಕ ಮತ್ತು ಆರ್ಥಿಕವಾಗಿ ಸಾಧ್ಯವಾದಾಗ ಜೀವನದಲ್ಲಿ ಒಮ್ಮೆ ಕಡ್ಡಾಯವಾಗಿದೆ. ಇಂದಿನ ಬಹುತೇಕ ಹದಿನಾಲ್ಕು ಶಿಯಾ ಯಾತ್ರಿಕರಿಗೆ, ಇದು ಇಬ್ರಾಹಿಂ (ಅಸ್), ಅವರ ಮಗ ಇಸ್ಮಾಯಿಲ್ (ಅಸ್) ಮತ್ತು ಲೇಡಿ ಹಾಜರ್ ಅವರ ಹೆಜ್ಜೆಗಳಲ್ಲಿ ಧುಲ್ ಹಿಜ್ಜಾ ತಿಂಗಳಲ್ಲಿ ನಡೆಯುವ ಹಜ್ಜ್ ಅಲ್-ತಮತ್ತು\' ಅನ್ನು ಅರ್ಥೈಸುತ್ತದೆ. ಈ ಮಾರ್ಗದರ್ಶಿ ಜಾಫರಿ ವಿಧಿಯ ರೂಪರೇಖೆಯನ್ನು ಅನುಸರಿಸುತ್ತದೆ, ಆದರೆ ಮದೀನದಲ್ಲಿ ಜಿಯಾರತ್ ಹಜ್ಜ್‌ಗಿಂತ ಮುಂಚೆ ಅಥವಾ ನಂತರದ ಆಳವಾದ ಪ್ರಿಯ ಯಾತ್ರೆಯಾಗಿದೆ.';
  ...
  @override
  String get voiceInputTitle => 'ಶ್ರವಣ ಇನ್ಪುಟ್';

  @override
  String get voiceInputMicTitle => 'ಮೈಕ್ರೋಫೋನ್';

  @override
  String get voiceInputMicSubtitle =>
      'ಟೈಪಿಂಗ್ ಮಾಡುವ ಬದಲು Ayara ಗೆ ನಿಮ್ಮ ಇನ್ಪುಟ್ ಅನ್ನು ಮಾತನಾಡಿ.';

  @override
  String get voiceInputMicDenied => 'ಮೈಕ್ರೋಫೋನ್ ಪ್ರವೇಶ ನಿರಾಕರಿಸಲಾಗಿದೆ.';

  @override
  String get voiceInputSpeak => 'ಬದಲಾಗಿ ಮಾತನಾಡಿ';

  @override
  String get voiceInputListening => 'ಕೋಶಿಸುತ್ತಿದೆ…';

  @override
  String get voiceInputPermissionDenied =>
      'ಶ್ರವಣ ಇನ್ಪುಟ್ ಗೆ ಮೈಕ್ರೋಫೋನ್ ಪ್ರವೇಶ ಅಗತ್ಯವಿದೆ.';
}
