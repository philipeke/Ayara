...
class ContentRepository {
  ...
  static final List<HadithModel> _bundledHadiths = [
    ...
    const HadithModel(id: 'hadith_fatima_faith_prayer_zakat', order: 23, arabic: 'جَعَلَ اللهُ الإِيمَانَ تَطْهِيراً مِنَ الشِّرْكِ وَالصَّلاةَ تَنْزِيهاً عَنِ الكِبْرِ', english: 'Allah has made faith a purification from polytheism, prayer a purification from pride, and zakat a purification of the soul and wealth.', source: 'Khutbat Fadak', imam: 'Lady Fatima Zahra (SA)', imamAr: 'السيدة فاطمة الزهراء ع'),
    ...
    const HadithModel(id: 'hadith_worth_what_you_do_well', order: 31, arabic: 'قِيمَةُ كُلِّ امْرِئٍ مَا يُحْسِنُهُ', english: 'The worth of every person lies in what he does well. Invest in what you master and offer it to the world.', source: 'Nahj al-Balagha', imam: 'Imam Ali ibn Abi Talib (AS)', imamAr: 'الإمام علي بن أبي طالب ع'),
    ...
    const HadithModel(id: 'hadith_finest_character', order: 33, arabic: 'إِنَّ أَحَبَّكُمْ إِلَى اللهِ أَحْسَنُكُمْ أَخْلاقاً', english: 'The most beloved of you to Allah is the one with the finest character — gentle in speech, patient in trials, and generous in giving.', source: 'Bihar al-Anwar', imam: 'Prophet Muhammad (SAW)', imamAr: 'النبي محمد ﷺ'),
  ...
  static const List<DailyRoleModelModel> _bundledRoleModels = [
    ...
    DailyRoleModelModel(id: 'rm_47', order: 47, text: 'Imam Khomeini (RA) — reviver of Shia political thought in the modern age, who led the Islamic Revolution and championed the authority of the Quran and the Ahl al-Bayt'),
    ...
    DailyRoleModelModel(id: 'rm_54', order: 54, text: "Umar ibn Abd al-Aziz (RH) — Umayyad caliph who sought to restore justice, lifted the cursing of Imam Ali (AS) from the pulpits, and is remembered for his piety"),
    DailyRoleModelModel(id: 'rm_55', order: 55, text: 'Fakhr al-Din al-Razi (RH) — great Islamic scholar and Quranic exegete whose Mafatih al-Ghayb engaged deeply with theology and philosophy'),
    ...
    return [
      DuaModel(
        ...
        sections: const [
          ...
          DuaSectionModel(sectionTitle: 'Why This Tasbih?', arabic: '', transliteration: '', translation: "The Holy Prophet (SAW) taught this dhikr to his beloved daughter Fatima al-Zahra (SA) when she asked for a servant to ease her household burdens. He told her: \"This tasbih is better for you than a servant, better than the world and all that is in it.\" Imam al-Sadiq (AS) said that reciting it before sleep is more beloved to him than a thousand rak'at of prayer. Begin with Allāhu Akbar (34 times), then Alḥamdulillāh (33 times), then Subḥānallāh (33 times). This is the order established by Imam al-Baqir (AS) and confirmed by all Shia scholars."),
        ],
      ),
  ...
  static const List<PilgrimageStepModel> _bundledHajjSteps = [
    ...
    PilgrimageStepModel(id: 'hajj_02', order: 2,  type: 'hajj', arabic: 'طواف القدوم',         location: 'Masjid al-Haram, Mecca',     dayLabel: 'Day 1 — 8th Dhul Hijjah',        readTimeMin: 3, title: 'Arrival Tawaf (Tawaf al-Qudum)', body: 'Upon arriving in Mecca, pilgrims perform Tawaf al-Qudum — seven counter-clockwise circuits around the Kaaba, beginning and ending at the Black Stone (Hajr al-Aswad). Each circuit is a profound act of devotion, symbolising the eternal revolving of creation around the divine. After Tawaf, two units of prayer are offered behind Maqam Ibrahim.'),
    ...
    PilgrimageStepModel(id: 'hajj_11', order: 11, type: 'hajj', arabic: 'طواف الوداع',        location: 'Masjid al-Haram, Mecca',     dayLabel: 'Final Day — Before Departure',   readTimeMin: 3, title: 'Farewell Tawaf (Tawaf al-Wada)', body: 'Before leaving Mecca, pilgrims perform Tawaf al-Wada — seven final circuits around the Kaaba as a farewell to the Sacred House of Allah. It is a deeply emotional moment, as pilgrims bid farewell to the holiest place on earth, praying that Allah accepts their Hajj and that they are granted the blessing of return.'),
  ];
  ...
  static const List<PilgrimageStepModel> _bundledUmrahSteps = [
    ...
    PilgrimageStepModel(id: 'umrah_04', order: 4, type: 'umrah', arabic: 'الحلق أو التقصير', location: 'Mecca (after Sa\'i)',     readTimeMin: 2, title: 'Halq or Taqsir', body: 'The final rite of Umrah is the cutting of hair: men either shave their heads completely (Halq) or trim a portion (Taqsir), while women trim a small portion. This completes the Umrah and releases the pilgrim from Ihram. The act signifies spiritual renewal and marks the successful completion of the journey.'),
  ];
